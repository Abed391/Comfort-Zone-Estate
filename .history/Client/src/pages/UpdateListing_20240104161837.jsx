...
export default function CreateListing() {
  ...
  const handleImageSubmit = (e) => {
    if (files.length > 0 && files.length + formData.imageUrls.length < 11) {
      ...
      setImageUploadError("You can only add up to 10 images per listing");
      setUploading(false);
    }
  };
      ...
      if (
        ...
        const handleSubmit = async (e) => {
          ...
          try {
            ...
            setLoading(true);
            setError(false);
            console.log(`/api/listing/update/${params.listingId}`);
            const res = await fetch(`/api/listing/update/659405976d2a79249bcc93f5`, {
              method: "POST",
              headers: {
